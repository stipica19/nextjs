        ...
        <div className="mt-8">
          <Swiper
            ...
            breakpoints={{
              ...
              1024: { slidesPerView: 3 }, // Laptopi i veći ekrani
            }}
            navigation
            ...
            {images.map((src, index) => (
              <SwiperSlide key={index} className="flex justify-center">
                <div className="relative w-full h-96">
                  <Image src={src} alt={`Hotel image ${index + 1}`} fill style={{ objectFit: "cover" }} className="rounded-lg shadow-lg" />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
